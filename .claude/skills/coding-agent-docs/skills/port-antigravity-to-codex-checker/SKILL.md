...
actually has. Consult the `coding-agent-docs:codex-docs` skill when you need current
...
- **Ground target details in `coding-agent-docs:codex-docs`.** Do not judge a gap from
