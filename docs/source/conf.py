# -*- coding: utf-8 -*-
#
# shsk_coding_agent_docs documentation build configuration file, created by
...
package_name = "shsk_coding_agent_docs"
...
# Add data for Jinja2
try:
    from shsk_coding_agent_docs.docs import doc_data
except:
    doc_data = dict()
